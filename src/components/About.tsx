    ...
    <div alt="About">
      ...
      <div className="flex justify-center p-6 ml-12">
        <p className="text-xl pl-6 border-l-2 border-slate-500">
          ...
          <br />
          Crafting and exploring new ideas have always been my favorite activities. When I'm not designing, I love spending time with family and friends, who inspire me every day.
          <br />
